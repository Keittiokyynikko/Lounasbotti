...
async function scrape_pantry(url, date_index) {
    ...
    const monday_vegan = '//*[@id="maanantai"]/div/div[5]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const monday_liha = '//*[@id="maanantai"]/div/div[1]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const monday_kala = '//*[@id="maanantai"]/div/div[3]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';

    const tuesday_vegan = '//*[@id="tiistai"]/div/div[5]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const tuesday_liha = '//*[@id="tiistai"]/div/div[1]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const tuesday_kala = '//*[@id="tiistai"]/div/div[3]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';

    const wednesday_vegan = '//*[@id="keskiviikko"]/div/div[5]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h4';
    const wednesday_liha = '//*[@id="keskiviikko"]/div/div[1]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const wednesday_kala = '//*[@id="keskiviikko"]/div/div[3]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';

    const thursday_vegan = '//*[@id="torstai"]/div/div[5]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6/span';
    const thursday_liha = '//*[@id="torstai"]/div/div[1]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6/span';
    const thursday_kala = '//*[@id="torstai"]/div/div[3]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6/span';

    const friday_vegan = '//*[@id="perjantai"]/div/div[5]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const friday_liha = '//*[@id="perjantai"]/div/div[1]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
    const friday_kala = '//*[@id="perjantai"]/div/div[3]/div/div/div[1]/div/div/div/div/div[2]/div[1]/h6';
