const greetings = {
  1: [
    ...
    'Viikonloput vietetty viimein on, taas työbotti palaa sorvin ääreen mukanaan lahna, sahti ja portobello',
  ],
  2: [
    ...
    'Ei ole sininen sunnuntai vaan sininen tiistai. Vai harmaa? Pohtikaa sitä lounaan äärellä.',
  ],
  3: [
    ...
    'Vaikka Lemmy työn raataja onkin, niin korkki ei avaudu vielä tänään. Sen sijaan sanainen arkkuni avautuu:',
  ],
  4: [
    'Torjandeita ihmistoverit! Huomenna on jo perjantai, joten jaksakaa siihen asti syömällä:',
    ...
    'Tänään on torstai. Toisille se on Törky-Torstai, toisille tujumpi torstai! Tässä tujua tavaraa:',
  ],
  5: [
    ...
    'Älä avaa vielä sitä kaljaa, odota hetki ja syö pohjalle!',
  ],
}
