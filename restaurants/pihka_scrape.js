...
async function scrape_pihka(url) {
	...
	const pihka_dessert = '//*[@id="main-content"]/article/div/div[2]/div/div/p[4]'
    ...
    const pihka_lunch_meat = {"name": pihka_meat_name}
    const pihka_lunch_vegan = {"name": pihka_vegan_name}
    const pihka_lunch_soup = {"name": pihka_soup_name}
    const pihka_lunch_dessert = {"name": pihka_dessert_name}

    return [pihka_lunch_meat, pihka_lunch_vegan, pihka_lunch_soup, pihka_lunch_dessert]

}

module.exports = {scrape_pihka};